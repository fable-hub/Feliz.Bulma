...
"""
            TagsInput.input [
                tagsInput.autoCompleteSource (fun _ ->
                    [
                        "Hello"
                        "FSharp"
                        "People"
        ...
        Bulma.content [
            ...
            Html.p [
                prop.dangerouslySetInnerHTML
                    "All previous examples are using uncontrolled approach. If you need to have control over input state, use <i>value</i> instead of <i>defaultValue</i>"
            ]
            code
