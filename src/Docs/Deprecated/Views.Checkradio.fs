...
"""
            ...
            Bulma.field.div [
                ...
                Html.label [
                    prop.htmlFor "myradio1"
                    prop.text "Option one"
                ]
                Checkradio.radio [
                    prop.id "myradio2"
                    prop.name "radio"
                ...
                Html.label [
                    prop.htmlFor "myradio2"
                    prop.text "Option two"
                ]
            ]
        ...
        Bulma.content [
            Html.p [
                prop.dangerouslySetInnerHTML
                    "All the modifiers mentioned in <a href='https://wikiki.github.io/form/checkradio/'>official documentation</a> will work as expected."
            ]
            code
                """open Feliz.Bulma
