...
let description =
    Html.div [
        Bulma.content [
            Html.p
                """This library extends Feliz.Bulma by adding DateTimePicker component based on Bulma calendar."""
...
"""
            ...
            DateTimePicker.timePicker [
                ...
                timePicker.onTimeRangeSelected (fun (v: (TimeSpan * TimeSpan) option) ->
                    () (* handle here *)
                )
            ]
            Html.p ""
...
"""
            ...
            DateTimePicker.timePicker [
                timePicker.onTimeSelected (fun (v: TimeSpan option) ->
                    JS.console.log (sprintf "onTimeSelected %A" v)
                )
                timePicker.onShow (fun _ -> JS.console.log ("onShow"))
                timePicker.onHide (fun _ -> JS.console.log ("onHide"))
            ]
...
"""
            ...
            DateTimePicker.dateTimePicker [
                dateTimePicker.dateOnly true
                dateTimePicker.onDateRangeSelected (fun (d: (DateTime * DateTime) option) ->
                    () (* handle here *)
                )
...
"""
            ...
            Html.p [
                Html.text
                    "When editing the date that is no range, user can be allowed to input the date manually."
            ]
            DateTimePicker.dateTimePicker [
                dateTimePicker.dateOnly true
                dateTimePicker.dateFormat "dd/MM/yyyy"
...
"""
            ...
            DateTimePicker.dateTimePicker [
                ...
                dateTimePicker.dateFromLabel "Check-in"
                dateTimePicker.dateToLabel "Check-out"
                dateTimePicker.defaultRangeValue (
