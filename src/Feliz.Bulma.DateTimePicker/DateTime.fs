...
type dateTimePicker =
    ...
    static member inline startDate (v:DateTime) : IDateTimePickerProperty = unbox ("startDate", v)
    static member inline endDate (v:DateTime) : IDateTimePickerProperty = unbox ("endDate", v)
    static member inline startTime (v:DateTime) : IDateTimePickerProperty = unbox ("startTime", v)
    static member inline endTime (v:DateTime) : IDateTimePickerProperty = unbox ("endTime", v)
