...
module Div =
    let inline props (cn: string) (xs: IReactProperty list) =
        Html.div (Helpers.combineClasses cn xs)

    let inline children (cn: string) (children: seq<ReactElement>) =
        Html.div [
            prop.className cn
    ...
    let inline valueStr (cn: string) (value: string) =
        Html.div [
            prop.className cn
            prop.text value
        ]

    let inline valueInt (cn: string) (value: int) =
        Html.div [
            prop.className cn
            prop.text value
        ]
...
module Nav =
    let inline props (cn: string) (xs: IReactProperty list) =
        Html.nav (Helpers.combineClasses cn xs)
...
module Article =
    let inline props (cn: string) (xs: IReactProperty list) =
        Html.article (Helpers.combineClasses cn xs)
...
module Section =
    let inline props (cn: string) (xs: IReactProperty list) =
        Html.section (Helpers.combineClasses cn xs)
...
module Footer =
    let inline props (cn: string) (xs: IReactProperty list) =
        Html.footer (Helpers.combineClasses cn xs)
...
module Label =
    let inline props (cn: string) (xs: IReactProperty list) =
        Html.label (Helpers.combineClasses cn xs)
...
module Textarea =
    let inline props (cn: string) (xs: IReactProperty list) =
        Html.textarea (Helpers.combineClasses cn xs)
...
module Button =
    let inline props (cn: string) (xs: IReactProperty list) =
        Html.button (Helpers.combineClasses cn xs)
...
module Span =
    let inline props (cn: string) (xs: IReactProperty list) =
        Html.span (Helpers.combineClasses cn xs)
...
module Figure =
    let inline props (cn: string) (xs: IReactProperty list) =
        Html.figure (Helpers.combineClasses cn xs)
...
module Progress =
    let inline props (cn: string) (xs: IReactProperty list) =
        Html.progress (Helpers.combineClasses cn xs)
...
module Table =
    let inline props (cn: string) (xs: IReactProperty list) =
        Html.table (Helpers.combineClasses cn xs)
...
module Aside =
    let inline props (cn: string) (xs: IReactProperty list) =
        Html.aside (Helpers.combineClasses cn xs)
...
module Header =
    let inline props (cn: string) (xs: IReactProperty list) =
        Html.header (Helpers.combineClasses cn xs)
